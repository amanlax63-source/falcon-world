...
*{box-sizing:border-box}html,body{margin:0;background:#020817;color:var(--text);font-family:Inter,ui-sans-serif,system-ui,-apple-system,BlinkMacSystemFont,"Segoe UI",sans-serif;-webkit-font-smoothing:antialiased}body{min-height:100vh;overflow-x:hidden;background:#020817 url('/falcon-bg.webp') center top/cover fixed no-repeat;position:relative}body:before{content:"";position:fixed;inset:0;pointer-events:none;background:linear-gradient(180deg,rgba(1,8,22,.22),rgba(1,8,22,.34) 42%,rgba(1,7,18,.48));z-index:-2}body:after{content:"";position:fixed;inset:0;pointer-events:none;background:radial-gradient(circle at 50% 24%,rgba(18,136,255,.14),transparent 34%),radial-gradient(circle at 12% 78%,rgba(0,93,255,.10),transparent 30%);z-index:-1}
button,input,textarea{font:inherit}button{border:0;color:inherit;cursor:pointer}.app{max-width:520px;margin:auto;padding:calc(13px + env(safe-area-inset-top)) 14px calc(100px + env(safe-area-inset-bottom))}.hidden{display:none!important}.fade{animation:fade .25s ease}@keyframes fade{from{opacity:0;transform:translateY(5px)}to{opacity:1;transform:none}}
.splash{position:fixed;inset:0;z-index:50;display:flex;align-items:center;justify-content:center;background:#020817 url('/falcon-bg.webp') center/cover no-repeat}.splash:after{content:"";position:absolute;inset:0;background:rgba(1,8,22,.38)}.splashInner{position:relative;z-index:1;text-align:center}.falcon{width:116px;height:116px;margin:auto;border-radius:38px;display:grid;place-items:center;background:linear-gradient(145deg,rgba(12,42,77,.82),rgba(4,14,29,.88));border:1px solid rgba(72,174,255,.55);box-shadow:0 0 55px rgba(0,143,255,.28),0 0 15px rgba(255,191,47,.12),inset 0 1px rgba(255,255,255,.12)}.falcon svg{width:76px;height:76px;color:#55b9ff;filter:drop-shadow(0 0 13px rgba(30,157,255,.65))}.splash h1{margin:20px 0 5px;font-size:30px;letter-spacing:-.8px}.splash p{margin:0;color:#a8bdd5;font-size:12px}.loader{width:190px;height:4px;background:rgba(255,255,255,.12);border-radius:99px;overflow:hidden;margin:24px auto 0}.loader i{display:block;width:45%;height:100%;background:linear-gradient(90deg,var(--blue),var(--gold),var(--blue));animation:load 1.1s infinite}@keyframes load{0%{transform:translateX(-120%)}100%{transform:translateX(330%)}}
.top{display:flex;align-items:center;justify-content:space-between;margin-bottom:12px}.brand{display:flex;align-items:center;gap:10px}.brandIcon{width:50px;height:50px;border-radius:18px;display:grid;place-items:center;background:rgba(3,19,40,.62);border:1px solid rgba(55,169,255,.7);font-size:28px;box-shadow:0 0 20px rgba(0,132,255,.24)}.brandText b{display:block;font-size:20px;letter-spacing:-.4px}.brandText span{font-size:10px;color:#5cbcff;letter-spacing:3px;text-transform:uppercase}.topActions{display:flex;align-items:center;gap:8px}.pill{padding:8px 12px;border:1px solid rgba(35,167,255,.55);border-radius:999px;background:rgba(2,18,37,.62);backdrop-filter:blur(15px);font-size:11px;color:#d8edff}.pill:before{content:"";display:inline-block;width:8px;height:8px;border-radius:50%;background:#19df9b;box-shadow:0 0 9px #19df9b;margin-right:6px}.more{width:36px;height:36px;border-radius:50%;background:rgba(2,18,37,.58);border:1px solid rgba(255,255,255,.12);font-size:20px}
.page{display:none}.page.active{display:block}.homeHero{position:relative;min-height:300px;padding:20px 8px 0;display:flex;align-items:flex-end;overflow:hidden}.homeHero:after{content:"";position:absolute;inset:0;background:linear-gradient(180deg,transparent 40%,rgba(2,8,20,.18) 65%,rgba(2,8,20,.5));pointer-events:none}.heroCopy{position:relative;z-index:1;margin:0 0 22px 6px}.heroCopy .eyebrow{color:#7dcaff;font-size:10px;letter-spacing:3px;font-weight:800}.heroCopy h1{margin:5px 0 0;font-size:25px;line-height:1.08;letter-spacing:1px;text-transform:uppercase;text-shadow:0 5px 25px rgba(0,0,0,.5)}.heroCopy h1 span{display:block;color:var(--gold)}
.balanceCard{position:relative;z-index:2;margin-top:-2px;padding:18px;border-radius:25px;background:linear-gradient(135deg,rgba(5,39,78,.76),rgba(3,17,36,.78));border:1px solid rgba(54,174,255,.72);box-shadow:0 0 28px rgba(0,127,255,.22),inset 0 1px rgba(255,255,255,.13);backdrop-filter:blur(18px)}.balanceRow{display:flex;align-items:center;justify-content:space-between;gap:10px}.balanceLabel{font-size:11px;color:#d2e4f5}.bigBalance{font-size:40px;line-height:1;margin:7px 0 5px;font-weight:900;letter-spacing:-1.7px;color:var(--gold);text-shadow:0 0 18px rgba(255,191,47,.16)}.balanceSub{font-size:12px;color:#a9c4df}.level{padding:10px 12px;border-radius:18px;border:1px solid rgba(255,191,47,.48);background:rgba(1,15,31,.48);min-width:105px}.level b{display:block;font-size:12px}.level span{display:block;color:#9db4cc;font-size:10px;margin-top:3px}
.sectionTitle{display:flex;justify-content:space-between;align-items:end;margin:20px 3px 10px}.sectionTitle h2{font-size:16px;margin:0}.sectionTitle span{font-size:10px;color:#8fa8c2}.grid3{display:grid;grid-template-columns:repeat(3,1fr);gap:9px}.action{min-height:126px;text-align:left;padding:13px 11px;border-radius:21px;background:linear-gradient(145deg,rgba(7,35,64,.78),rgba(3,15,31,.76));border:1px solid rgba(70,166,255,.34);box-shadow:0 12px 28px rgba(0,0,0,.22),inset 0 1px rgba(255,255,255,.06);backdrop-filter:blur(16px);transition:.16s}.action:active{transform:scale(.97)}.action .ico{width:42px;height:42px;border-radius:50%;display:grid;place-items:center;font-size:21px;margin-bottom:14px;background:rgba(16,122,255,.17);border:1px solid rgba(55,174,255,.48);box-shadow:0 0 16px rgba(0,137,255,.18)}.action:nth-child(2) .ico{background:rgba(129,71,255,.18);border-color:rgba(161,106,255,.48)}.action:nth-child(3) .ico{background:rgba(255,164,0,.18);border-color:rgba(255,191,47,.58)}.action:nth-child(4) .ico{background:rgba(27,133,255,.18)}.action:nth-child(5) .ico{background:rgba(22,202,174,.16);border-color:rgba(50,224,195,.45)}.action:nth-child(6) .ico{background:rgba(255,191,47,.16);border-color:rgba(255,191,47,.45)}.action:nth-child(7) .ico{background:rgba(255,65,108,.15);border-color:rgba(255,91,128,.48)}.action b{display:block;font-size:13px}.action small{display:block;margin-top:4px;color:#91b1ce;font-size:9px;line-height:1.25}.wideGrid{display:grid;grid-template-columns:1fr 1fr;gap:9px}.wide{min-height:86px;text-align:left;padding:15px;border-radius:22px;background:linear-gradient(145deg,rgba(31,21,74,.72),rgba(4,17,37,.78));border:1px solid rgba(90,109,255,.43);backdrop-filter:blur(16px);box-shadow:0 12px 28px rgba(0,0,0,.2)}.wide b{display:block;font-size:13px;margin-top:9px}.wide small{color:#93b0cb;font-size:9px}.wide .ico{font-size:22px}.wide:last-child{background:linear-gradient(145deg,rgba(8,45,78,.76),rgba(3,18,38,.78));border-color:rgba(43,171,255,.48)}.banner{margin-top:12px;padding:14px 16px;border-radius:21px;background:linear-gradient(90deg,rgba(5,30,60,.8),rgba(6,22,46,.72));border:1px solid rgba(58,161,255,.28);backdrop-filter:blur(15px)}.banner b{display:block;color:var(--gold);font-size:13px}.banner span{font-size:10px;color:#a6bfd8}
.card{padding:18px;border-radius:var(--r);background:rgba(5,18,36,.76);border:1px solid rgba(76,168,255,.28);box-shadow:0 15px 38px rgba(0,0,0,.2);margin-bottom:12px;backdrop-filter:blur(18px)}.hero{position:relative;overflow:hidden;padding:20px;border-radius:26px;background:linear-gradient(145deg,rgba(6,35,67,.75),rgba(3,15,31,.78));border:1px solid rgba(68,171,255,.4);box-shadow:0 18px 48px rgba(0,0,0,.22);backdrop-filter:blur(16px)}.hero:after{content:"";position:absolute;width:180px;height:180px;right:-80px;top:-80px;border-radius:50%;background:rgba(33,167,255,.16);filter:blur(12px)}.eyebrow{font-size:10px;color:#8ecbff;text-transform:uppercase;letter-spacing:1.8px}.heroSub{font-size:11px;color:#a3b9d1}.statGrid{display:grid;grid-template-columns:1fr 1fr;gap:9px}.stat{padding:14px;border-radius:17px;background:rgba(255,255,255,.035);border:1px solid rgba(90,169,255,.2)}.stat span{display:block;color:#8fa8c1;font-size:9px;margin-bottom:6px}.stat b{font-size:14px}.muted{color:#9eb4cb;font-size:11px;line-height:1.55}.back{background:transparent;color:#a9c6e0;padding:8px 0;font-size:12px;margin-bottom:10px}.primary{width:100%;padding:14px;border-radius:16px;background:linear-gradient(135deg,#149eff,#225fff);font-weight:850;box-shadow:0 10px 28px rgba(20,151,255,.2);margin-top:10px}.secondary{width:100%;padding:13px;border-radius:16px;background:rgba(7,25,47,.75);border:1px solid rgba(90,169,255,.24);font-weight:700;margin-top:9px}.field{margin-top:12px}.field label{font-size:10px;color:#a7bfd7}.field input,.field textarea,.field select{width:100%;margin-top:7px;padding:14px;border-radius:14px;border:1px solid rgba(83,170,255,.25);background:rgba(1,13,28,.76);color:#fff;outline:none}.field textarea{min-height:110px;resize:none}.notice{padding:12px 13px;border-radius:14px;font-size:11px;margin-top:10px}.ok{background:rgba(53,231,164,.08);border:1px solid rgba(53,231,164,.22);color:#8af0bc}.warn{background:rgba(255,191,47,.08);border:1px solid rgba(255,191,47,.2);color:#ffd98a}.err{background:rgba(255,95,122,.08);border:1px solid rgba(255,95,122,.2);color:#ff9ca7}.channel{display:flex;align-items:center;gap:10px;padding:12px;margin:8px 0;border-radius:16px;background:rgba(4,22,42,.72);border:1px solid rgba(75,164,255,.2)}.channelIcon{width:38px;height:38px;border-radius:12px;display:grid;place-items:center;background:rgba(25,126,235,.15)}.channelMain{flex:1}.channelMain b{display:block;font-size:12px}.channelMain span{font-size:9px;color:#91a9c0}.join{padding:9px 11px;border-radius:11px;background:#0d4b7e;color:#a5d9ff;font-size:10px;font-weight:850}.joined{font-size:10px;color:var(--green);font-weight:850}.task{padding:15px;border-radius:18px;background:linear-gradient(145deg,rgba(8,30,54,.76),rgba(4,16,30,.78));border:1px solid rgba(75,164,255,.22);margin:10px 0}.taskTop{display:flex;justify-content:space-between;gap:10px}.task h3{margin:0;font-size:13px}.reward{color:#79c0ff;font-weight:850;font-size:11px;white-space:nowrap}.task p{color:#9cb4cc;font-size:10px;line-height:1.5}.task a{color:#83c4ff;text-decoration:none}.taskStatus{font-size:9px;color:#a9bbcf}.task textarea{width:100%;padding:12px;border-radius:12px;background:#07111e;border:1px solid rgba(83,170,255,.22);color:#fff;margin-top:8px;min-height:80px}.walletChoice{display:grid;grid-template-columns:1fr 1fr;gap:10px}.walletBtn{padding:18px 12px;border-radius:18px;background:rgba(5,22,40,.75);border:1px solid rgba(83,170,255,.2);text-align:left}.walletBtn.active{border-color:rgba(55,174,255,.7);background:linear-gradient(145deg,rgba(14,54,91,.82),rgba(5,22,42,.82))}.walletBtn b{display:block;margin-top:8px}.walletBtn small{color:#91a9c0;font-size:9px}.mask{font-family:monospace;letter-spacing:1px;color:#bcd0e8}.copyBox{display:flex;gap:8px}.copyBox input{flex:1}.copyBox button{width:52px;border-radius:14px;background:rgba(12,42,70,.78);border:1px solid rgba(90,169,255,.25)}
.profileCard{text-align:center;padding:24px}.profileAvatar{width:76px;height:76px;border-radius:50%;display:grid;place-items:center;margin:0 auto 12px;background:linear-gradient(145deg,#0d4c83,#071b34);border:2px solid rgba(41,171,255,.7);font-size:38px;box-shadow:0 0 28px rgba(0,135,255,.25)}.profileName{font-size:19px;font-weight:850}.profileUser{font-size:11px;color:#8da8c1;margin-top:3px}
.nav{position:fixed;left:50%;bottom:9px;transform:translateX(-50%);width:min(500px,calc(100% - 18px));display:grid;grid-template-columns:1fr 1fr 1fr 1fr 1fr;padding:6px;border-radius:25px;background:rgba(2,13,28,.86);backdrop-filter:blur(24px);border:1px solid rgba(70,167,255,.3);box-shadow:0 10px 35px rgba(0,0,0,.45);z-index:20}.nav button{background:transparent;padding:6px 2px;border-radius:16px;color:#7f9bb8;font-size:9px}.nav button.active{color:#35b5ff}.nav i{font-style:normal;display:block;font-size:18px;margin-bottom:2px}.nav .center{position:relative;margin-top:-25px;width:58px;height:58px;justify-self:center;border-radius:50%;padding:0;background:linear-gradient(145deg,#071d38,#041123);border:2px solid var(--gold);box-shadow:0 0 22px rgba(255,191,47,.28),0 0 10px rgba(25,158,255,.3);font-size:0}.nav .center:after{content:"🦅";font-size:29px;position:absolute;inset:0;display:grid;place-items:center}.nav .center span{display:none}
@media(max-width:390px){.app{padding-left:10px;padding-right:10px}.grid3{gap:7px}.action{padding:11px 9px;min-height:120px}.action b{font-size:12px}.bigBalance{font-size:35px}.brandText b{font-size:18px}.wideGrid{gap:7px}}
</style>
</head>
<body>
...
<div class="app" id="app">
  ...
  <section id="home" class="page">
    <div class="homeHero"><div class="heroCopy"><div class="eyebrow">Stronger Together</div><h1>Falcon <span>World</span></h1></div></div>
    <div class="balanceCard"><div class="balanceRow"><div><div class="balanceLabel">Your Balance</div><div class="bigBalance" id="balance">0.00 ETB</div><div class="balanceSub">≈ 0.00 USDT</div></div><div class="level"><b>🛡 Level 1</b><span>New Member</span></div></div></div>
    <div class="sectionTitle"><h2>Quick Actions</h2><span>7 features</span></div>
    <div class="grid3">
      <button class="action" onclick="go('tasks')"><div class="ico">📋</div><b>Tasks</b><small>Complete & Earn</small></button>
      <button class="action" onclick="go('daily')"><div class="ico">🎁</div><b>Daily Bonus</b><small>Claim Reward</small></button>
      <button class="action" onclick="go('referral')"><div class="ico">👥</div><b>Referral</b><small>Invite & Earn</small></button>
      <button class="action" onclick="go('wallet')"><div class="ico">💳</div><b>Wallet</b><small>Manage Funds</small></button>
      <button class="action" onclick="go('withdraw')"><div class="ico">💸</div><b>Withdraw</b><small>Get Your Earnings</small></button>
      <button class="action" onclick="go('support')"><div class="ico">🆘</div><b>Support</b><small>We're Here</small></button>
    </div>
    <div class="wideGrid" style="margin-top:9px">
      <button class="wide" onclick="openSupport()"><div class="ico">↔️</div><b>USDT Exchange</b><small>Buy & Sell</small></button>
      <button class="wide" onclick="openSupport()"><div class="ico">📢</div><b>Ads & Promotions</b><small>DM @AmanM_12</small></button>
    </div>
    <div class="banner"><b>⚡ Small Steps Make Big Rewards</b><span>Join · Complete · Earn</span></div>
  </section>
  ...
  <section id="channelsPage" class="page"><button class="back" onclick="go('home')">← Back to Home</button><div class="hero"><div class="eyebrow">Community</div><div style="font-size:25px;font-weight:850;margin-top:7px">Required Channels</div><div class="muted" style="margin-top:7px">Stay connected with Falcon World and complete your membership verification.</div></div><div class="card" style="margin-top:12px"><div id="appChannels">Loading…</div><button class="primary" onclick="verifyAppChannels()">✓ Verify Membership</button><div id="appChannelMsg"></div></div></section>

  <section id="historyPage" class="page"><button class="back" onclick="go('home')">← Back to Home</button><div class="hero"><div class="eyebrow">Activity</div><div style="font-size:25px;font-weight:850;margin-top:7px">History</div><div class="muted" style="margin-top:7px">Your recent withdrawal activity.</div></div><div id="historyList" class="card" style="margin-top:12px">Loading…</div></section>

  <section id="profilePage" class="page"><button class="back" onclick="go('home')">← Back to Home</button><div class="card profileCard"><div class="profileAvatar">🦅</div><div class="profileName" id="profileName">Falcon World Member</div><div class="profileUser" id="profileUsername">Telegram account</div></div><div class="card"><div class="statGrid"><div class="stat"><span>TELEGRAM ID</span><b id="profileId">—</b></div><div class="stat"><span>STATUS</span><b>Verified</b></div><div class="stat"><span>WALLET</span><b id="profileWallet">Not set</b></div><div class="stat"><span>BALANCE</span><b id="profileBalance">0.00 ETB</b></div></div></div><button class="primary" onclick="go('wallet')">💳 Manage Wallet</button></section>

</div>
<div class="nav" id="nav"><button id="navHome" onclick="go('home')"><i>⌂</i>Home</button><button id="navChannels" onclick="go('channelsPage')"><i>◈</i>Channels</button><button class="center" onclick="go('home')"><span>Falcon</span></button><button id="navHistory" onclick="go('historyPage')"><i>◷</i>History</button><button id="navProfile" onclick="go('profilePage')"><i>●</i>Profile</button></div>
<script>
const tg=window.Telegram?.WebApp; if(tg){tg.ready();tg.expand();try{tg.setHeaderColor('#020817');tg.setBackgroundColor('#020817')}catch(e){}}
...
function setPage(id){document.querySelectorAll('.page').forEach(x=>x.classList.remove('active'));document.getElementById(id)?.classList.add('active');document.getElementById(id)?.classList.add('fade');window.scrollTo({top:0,behavior:'smooth'});document.getElementById('nav').style.display=id==='verifyPage'?'none':'grid';['navHome','navChannels','navHistory','navProfile'].forEach(x=>document.getElementById(x)?.classList.remove('active'));const navMap={home:'navHome',channelsPage:'navChannels',historyPage:'navHistory',profilePage:'navProfile'};document.getElementById(navMap[id])?.classList.add('active')}
function go(id){setPage(id);if(id==='home'||id==='balancePage'||id==='withdraw'||id==='profilePage')loadMe();if(id==='referral')loadReferral();if(id==='daily')loadDaily();if(id==='wallet')renderWallet();if(id==='tasks')loadTasks();if(id==='channelsPage')loadAppChannels();if(id==='historyPage')loadHistory();if(id==='profilePage')loadProfile()}
function openLink(url){if(tg?.openTelegramLink)tg.openTelegramLink(url);else window.open(url,'_blank')}
async function loadAppChannels(){const box=document.getElementById('appChannels');box.innerHTML='Loading…';try{const d=await api('/api/verify');const missing=d.channels.filter(x=>!x.joined);let html='<div class="notice warn">'+(d.verified_count||0)+'/'+(d.total||d.channels.length)+' channels joined</div>';html+=d.channels.map(ch=>`<div class="channel"><div class="channelIcon">📣</div><div class="channelMain"><b>${esc(ch.name)}</b><span>${esc(ch.username)}</span></div>${ch.joined?'<span class="joined">✓ Joined</span>':`<button class="join" data-url="${esc(ch.url)}" onclick="openLink(this.dataset.url)">Join</button>`}</div>`).join('');box.innerHTML=html}catch(e){box.innerHTML='<div class="notice err">'+esc(e.message)+'</div>'}}
async function verifyAppChannels(){const msg=document.getElementById('appChannelMsg');msg.innerHTML='<div class="notice warn">Checking membership…</div>';try{const d=await api('/api/verify',{method:'POST',body:'{}'});if(d.verified){msg.innerHTML='<div class="notice ok">✓ Membership verified.</div>';loadAppChannels();}else{msg.innerHTML='<div class="notice warn">'+d.verified_count+'/'+d.total+' channels joined. Join the remaining channels.</div>';loadAppChannels()}}catch(e){msg.innerHTML='<div class="notice err">'+esc(e.message)+'</div>'}}
async function loadHistory(){const box=document.getElementById('historyList');box.innerHTML='Loading…';try{const d=await api('/api/history');if(!d.items.length){box.innerHTML='<div class="muted">No withdrawal history yet.</div>';return}box.innerHTML=d.items.map(x=>`<div class="stat" style="margin-bottom:9px"><div style="display:flex;justify-content:space-between"><b>${money(x.amount)}</b><b>${esc(x.status)}</b></div><div class="muted" style="margin-top:5px">${esc(x.wallet_type)} • ${esc(x.wallet_mask)}<br>${esc(x.created)}</div></div>`).join('')}catch(e){box.innerHTML='<div class="notice err">'+esc(e.message)+'</div>'}}
function loadProfile(){if(!userData)return;document.getElementById('profileName').textContent=userData.first_name||'Falcon World Member';document.getElementById('profileUsername').textContent=userData.username?'@'+userData.username:'Telegram account';document.getElementById('profileId').textContent=userData.user_id||'—';document.getElementById('profileWallet').textContent=userData.wallet_type||'Not set';document.getElementById('profileBalance').textContent=money(userData.balance||0)}
...
async def api_history(request: Request):
    ...
    conn = db()
    try:
        rows = conn.execute("SELECT amount,wallet_type,wallet_number,status,created_at FROM withdrawals WHERE user_id=? ORDER BY id DESC LIMIT 30", (uid,)).fetchall()
    finally:
        conn.close()
    items=[]
    for r in rows:
        n=r["wallet_number"] or ""
        masked=(n[:4]+'*'*(max(0,len(n)-6))+n[-2:]) if len(n)>6 else n
